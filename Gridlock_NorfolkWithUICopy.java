...
public class Gridlock_NorfolkWithUICopy extends GUIState
{
    ...
    protected Gridlock_NorfolkWithUICopy(SimState state)
    {
        super(state);
    }
    ...
    {
        Gridlock_NorfolkWithUICopy simple = new Gridlock_NorfolkWithUICopy(new Gridlock_NorfolkCopy(System.currentTimeMillis()));
    ...
    public void start()
    {
        ...
        Gridlock_NorfolkCopy world = (Gridlock_NorfolkCopy) state;
        ...
        state.schedule.scheduleRepeating(new Steppable()
        {
            ...
            public void step(SimState state)
            {
                ...
                for (AgentCopy a : world.agentList)
                {
