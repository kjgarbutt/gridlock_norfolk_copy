...
//    }
    ...
    public AgentCopy(Gridlock_NorfolkCopy g, String home, String work,
     ...
     */
    public boolean start(Gridlock_NorfolkCopy state)
    {
    ...
    private void findNewAStarPath(Gridlock_NorfolkCopy geoTest)
    {
    ...
    public void step(SimState state)
    {
        ...
        boolean toWork = ((Gridlock_NorfolkCopy) state).goToWork;
